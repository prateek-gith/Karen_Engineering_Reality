...
API_KEY = 'Your_Google_Search_API_Key'  # Your Google API Key
CX = 'Your_Custom_Search_Engine_ID'  # Your Custom Search Engine ID (CX)
...
def collect_emails(query, max_results=1000):
    ...
    while len(emails) < max_results:
        ...
        start += 10
        if start > 100:  # Limit to 100 results due to API restrictions
            print("Reached API limit for pagination.")
            break
